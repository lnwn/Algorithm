// 5-count-inversion-number.cpp : 统计数组中任意两数组成的逆序数个数。
// 2020/02/26
// 分治算法：将原问题分割成同等结构的子问题来解决。归并排序（Merger Sort）与快速排序（Quick Sort）都使用了分治算法
// 暴力解法：比较每一个数对。算法时间复杂度 O(n2)
// 归并算法：一次比较一组，算法时间复杂度 O(nlogn)
...
// merge函数求出【【【在 arr[l...mid]和 arr[mid+1...r]有序的基础上】】】arr[l...r]的逆序数对个数
